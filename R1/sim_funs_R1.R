do_one_sim <- function(settings)
{
  ...
  stuff <- limestest:::loglik_psi(Z = Z, ZtZXe = cbind(ZtZ, t(XtZ), Zte), e = e,
                                  H = H, Psi_r = Psi_r, psi_r = psi[r],
                                  get_val = TRUE, get_score = TRUE,
                                  get_inf = TRUE, expected = TRUE)
  ...
  stuff_at_est <- limestest:::loglik_psi(Z = Z, ZtZXe = cbind(ZtZ, t(XtZ), Zte), e = e,
                                  H = H, Psi_r = Psi_hat_r, psi_r = psi_hat[r],
                                  get_val = TRUE, get_score = FALSE,
                                  get_inf = TRUE, expected = FALSE)
  ...
  # Return
  c("PSCR" = test_stat, "RSCR" = test_stat_REML, "LRT" = test_stat_lrt,
    "WLD" = test_stat_wald)
}
